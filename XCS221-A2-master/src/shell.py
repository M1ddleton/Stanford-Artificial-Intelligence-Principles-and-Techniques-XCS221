                ...
                (
                    "\n".join(
                        ...
                        for a, b in [
                            ...
                            (
                                "fills",
                                "Query possibleFills() to see possible vowel-fillings of a word",
                            ),
                            (
                                "ug",
                                "Query unigram cost function, treating input as a single word",
                            ),
                            (
                                "bg",
                                "Call bigram cost function on the last two words of the input",
                            ),
                        ]
                    )
                )
